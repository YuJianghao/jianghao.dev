...
<template>
  <div class="mt-10 op-40 hover:op-100 transition-200">
    <div v-for="activity in activities" :key="activity.id">
      <div class="max-w-7xl mx-auto md:pl-12 pl-0 text-gray-4 dark:text-gray-6 py-1 hover:text-orange hover:bg-#77777720 transition-100 select-none cursor-pointer" @click="onClick(activity)">
